package com.rbmhtechnology.vind.solr.server;
...
import com.rbmhtechnology.vind.solr.SolrSearchServer;
import com.rbmhtechnology.vind.solr.utils.Asset;
...
public class SolrSearchServerTest {
    ...
    public void testConfigureProviderHostCoreReal() throws Exception {
        ...
        SearchServer server = SearchServer.getInstance("com.rbmhtechnology.vind.solr.RemoteSolrServerProvider","http://localhost:8983/solr","assets");
        server.commit();
    }
}