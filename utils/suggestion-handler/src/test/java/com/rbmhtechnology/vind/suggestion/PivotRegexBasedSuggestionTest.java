...
public class PivotRegexBasedSuggestionTest extends SolrTestCaseJ4 {
    ...
    public static void init() throws Exception {
        ...
        assertU(adoc("_id_", "1",
                ...
                "dynamic_multi_stored_facet_date_date", "2016-07-08T10:00:00Z"));
        assertU(adoc("_id_", "2",
                "_type_","Asset",
                "dynamic_multi_stored_facet_string_name", "sebastien loeb",
                "dynamic_multi_stored_facet_date_date", "2016-09-07T10:00:00Z"));
        assertU(adoc("_id_", "3",
                "_type_","Asset",
        ...
        assertU(adoc("_id_", "4",
                ...
                "dynamic_multi_stored_facet_date_date", "2016-09-08T10:00:00Z"));
        assertU(adoc("_id_", "5",
                "_type_","Asset",
        ...
        assertU(adoc("_id_", "9",
                "_type_","Asset",
                "dynamic_multi_stored_facet_string_name", "sebastien vettel",
                "dynamic_multi_stored_facet_date_date", "2016-09-07T10:00:00Z"));
        assertU(commit());
    }
    ...
    public void testSuggestionIntervals() {
        ...
        params.add(SuggestionRequestParams.SUGGESTION_INTERVAL_FIELD,"dynamic_multi_stored_facet_date_date");
        ...
        assertQ("suggester - simple facet suggestion for 'lo'",req,
                ...
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_week']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien loeb'][.='1']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_year']/int[@name='suggestion_count'][.='1']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_year']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien loeb'][.='2']");
        ...
        assertQ("suggester - simple facet suggestion for 'seb'",req,
                ...
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_week']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien loeb'][.='1']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_week']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien vettel'][.='1']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_year']/int[@name='suggestion_count'][.='3']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_year']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien loeb'][.='2']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_intervals']/lst[@name='last_year']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien vettel'][.='1']");
    ...
    public void testSuggestionNoIntervals() {
        ...
        assertQ("suggester - simple facet suggestion for 'sebasti'",req,
                ...
                "//response/lst[@name='suggestions']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_facet_string_name']/int[@name='sebastien vettel'][.='1']");
