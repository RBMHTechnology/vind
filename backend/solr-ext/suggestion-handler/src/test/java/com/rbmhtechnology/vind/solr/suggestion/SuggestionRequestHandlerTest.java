...
public class SuggestionRequestHandlerTest extends SolrTestCaseJ4 {
    ...
    public void setUp() throws Exception {
        ...
        assertU(adoc("_id_", "1",
                ...
                "dynamic_multi_stored_suggest_string_name", "mark webber",
                "dynamic_multi_stored_suggest_string_place", "Japan",
                "dynamic_multi_stored_suggest_string_place", "Wuppertal",
                "dynamic_multi_stored_suggest_string_place", "(1328869589310-619798898)",//for fq test
                "dynamic_multi_stored_suggest_string_place", "suzuka",
        ...
        assertU(adoc("_id_", "2",
                "_type_","Asset",
                "dynamic_multi_stored_suggest_string_name", "sebastian vettel",
                "dynamic_multi_stored_suggest_string_name", "Daniel Ricciardo",
                "dynamic_multi_stored_suggest_string_place", "Malaysia",
                "dynamic_multi_stored_suggest_string_place", "kuala Lumpur",
                "dynamic_single_stored_suggest_path_path1", "FIA Formula One World Championship 2012 - kuala Lumpur",
                "dynamic_single_stored_suggest_path_path2", "Red Bull Racing Team"));
        assertU(adoc("_id_", "3",
                "_type_","Asset",
                "dynamic_multi_stored_suggest_string_name", "stefan Bradl",
                "dynamic_multi_stored_suggest_string_place", "Japan",
                "dynamic_multi_stored_suggest_string_place", "suzuka",
                "dynamic_multi_stored_suggest_string_place", "kuala Lumpur",
                "dynamic_multi_stored_suggest_string_brand",  "citroën",
                "dynamic_single_stored_suggest_path_path1", "Stefan Bradl - Lifestyle"));
        assertU(adoc("_id_", "4",
                "_type_","Asset",
                "dynamic_multi_stored_suggest_string_name", "X-Fighters",
                "dynamic_multi_stored_suggest_string_place", "Red Bull"));
        assertU(adoc("_id_", "5",
                "_type_","Asset",
                "dynamic_multi_stored_suggest_string_name", "RBXF",
                "dynamic_multi_stored_suggest_string_place", "RB"));
        assertU(adoc("_id_", "6",
                "_type_","Asset",
                "dynamic_multi_stored_suggest_string_place", "Havanna kuba",
                "dynamic_multi_stored_suggest_string_place", "kurdistan"));
        assertU(commit());
    }
    ...
    public void testCharacterMapping() {
        ...
        params.add(SuggestionRequestParams.SUGGESTION_FIELD,"dynamic_multi_stored_suggest_string_brand");
        params.add(SuggestionRequestParams.SUGGESTION_DF,"suggestions");
        ...
        assertQ("suggester - character mapping 'Citroën'", req,
                "//response/lst[@name='suggestions']/int[@name='suggestion_count'][.='1']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_suggest_string_brand']/int[@name='citroën'][.='1']");
