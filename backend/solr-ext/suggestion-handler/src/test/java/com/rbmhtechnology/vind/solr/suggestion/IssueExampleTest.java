...
public class IssueExampleTest extends SolrTestCaseJ4 {
    ...
    public void test_MBC_1166() {
        ...
        params.add(SuggestionRequestParams.SUGGESTION_DF,"dynamic_multi_stored_suggest_string_name");
    ...
    public void NumberTest() {
        ...
        params.add(SuggestionRequestParams.SUGGESTION_FIELD,"dynamic_multi_stored_suggest_string_subtitle");
        params.add(SuggestionRequestParams.SUGGESTION_DF,"suggestions");
        ...
        assertQ("suggester - test number search",req,
                "//response/lst[@name='suggestions']/int[@name='suggestion_count'][.='1']",
                "//response/lst[@name='suggestions']/lst[@name='suggestion_facets']/lst[@name='dynamic_multi_stored_suggest_string_subtitle']/int[@name='Subtitle 123'][.='1']");
    ...
    public void test_MBV_351() {
        ...
        params2.add(SuggestionRequestParams.SUGGESTION_FIELD,"dynamic_multi_stored_suggest_string_name");
    ...
    public void test_MBC_2527() {
        ...
        params.add(SuggestionRequestParams.SUGGESTION_FIELD, "dynamic_multi_stored_suggest_string_index");
        params.add(SuggestionRequestParams.SUGGESTION_DF, "suggestions");
