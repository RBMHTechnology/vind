...
import static com.rbmhtechnology.vind.solr.SolrUtils.Fieldname.UseCase;
import static com.rbmhtechnology.vind.solr.SolrUtils.Fieldname.getFieldname;
...
public  class SolrFilterSerializerVisitor implements SerializerVisitor {
    ...
    public String visit(Filter.TermFilter filter) {
        ...
        if (this.isHierarchical(filter.getField()) && !strict) {
            final UseCase useCase = UseCase.valueOf(filter.getFilterScope(filter.getField(), this.childFactory).toString());
            ...
            final UseCase useCase = UseCase.valueOf(filter.getFilterScope(filter.getField(), this.parentFactory).toString());
    ...
    public String visit(Filter.DescriptorFilter filter){
        ...
        if (this.isHierarchical(filter.getDescriptor().getName()) && !strict) {
            final UseCase useCase = UseCase.valueOf(filter.getFilterScope(filter.getDescriptor().getName(), this.childFactory).toString());
            ...
            final UseCase useCase = UseCase.valueOf(filter.getFilterScope(filter.getDescriptor().getName(), this.parentFactory).toString());
    ...
    private String getFieldName(String name, String searchContext, UseCase usecase, DocumentFactory factory) {
        ...
        final String fieldName = getFieldname(descriptor, usecase, searchContext);
