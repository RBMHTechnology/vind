...
public class SolrUtilsTest {
    ...
    public void testFieldNameConfiguration() {
        ...
        assertEquals("dynamic_multi_float_test1", SolrUtils.Fieldname.getFieldname(facet, UseCase.Stored, null));
        ...
        assertEquals("dynamic_multi_facet_int_test3", SolrUtils.Fieldname.getFieldname(stored2, UseCase.Facet, null));
        ...
        assertEquals("dynamic_multi_facet_string_test4", SolrUtils.Fieldname.getFieldname(mixed, UseCase.Facet, null));
        assertEquals("dynamic_multi_string_test4", SolrUtils.Fieldname.getFieldname(mixed, UseCase.Stored, null));
        assertEquals("dynamic_multi_none_test4", SolrUtils.Fieldname.getFieldname(mixed, UseCase.Fulltext, null));
